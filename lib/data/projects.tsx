...
export const projects: Project[] = [
     ...
     liveUrl: "https://your-saas-demo-url.com/",
      services: [   { icon: <MessageSquare className="h-3.5 w-3.5 text-slate-700 mr-1.5" />,
                    ...
                    { icon: <Image className="h-3.5 w-3.5 text-slate-700 mr-1.5" />,
                       name: "Image Generation" },
                     { icon: <Music className="h-3.5 w-3.5 text-slate-700 mr-1.5" />,
                       name: "Music Generation" },
                 {   icon: <Video className="h-3.5 w-3.5 text-slate-700 mr-1.5" />,
    ...
    },
 {
    ...
    },
    {
      ...
      services: [
        { icon: <Lock className="h-3.5 w-3.5 text-slate-700 mr-1.5" />,
           name: "Encrypted Env Storage" },
        { icon: <Share2 className="h-3.5 w-3.5 text-slate-700 mr-1.5" />, 
                 name: "Team Syncing" },
      ],
      featured:false,
      results: [
